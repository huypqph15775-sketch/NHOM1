    ...
    <div class="row mt-5">
        ...
        <div class="col-md-3 mb-3">
            <div class="card text-dark h-100" style="background:#FFFF00;">
                <div class="card-body">
                    <i class="fas fa-users" style="font-size: 90px; color:black"></i>
                    <h5 class="card-title"><?php echo $count_customer; ?> Khách hàng</h5>
                </div>
                <div class="card-footer d-flex justify-content-between" style="background:rgba(0,0,0,0.1)">
        ...
        <div class="col-md-3 mb-3">
            <div class="card text-white h-100" style="background:#0066FF">
                <div class="card-body">
                    ...
                    <h5 class="card-title"><?php echo $total_stock; ?> SP tồn kho</h5>
                </div>
                <div class="card-footer d-flex justify-content-between">
        ...
        <div class="col-md-3 mb-3">
            <div class="card text-white h-100" style="background:#00CC00">
                ...
                <div class="card-footer d-flex justify-content-between">
                    <a href="index.php?report" class="text-white text-decoration-none">Xem chi tiết</a>
                    <i class="fas fa-angle-right"></i>
                </div>
            </div>
        </div>
