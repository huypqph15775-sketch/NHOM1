...
(1, 'Hoang Tiep', 'tiep184@gmail.com', 'admin', '1234', 'avatar1.jpg', 'Hanoi', '0123456789', 'Quản lý', 4),
(4, 'huyadmin', 'huay@gmail.com', 'huyadmin', '1234', 'anh.png', 'abc', '0987565234', 'Quản lý', 4),
(5, 'nhanvien', 'nv@gmail.com', 'nhanvien1', '1234', '', 'abc', '098758965234', 'Nhân viên', 4);
...
(5, 'Vũ Ngọc Vỹ', 'Nam', 'vyez184@gmail.com', '+84363811478', 'ha noi', 'vuvy', 1234, '', 'Active', 1),
(6, 'abc', 'Nam', 'ldn@ldn.vn', '12345678', 'hanoi', 'abc', 1234, '', 'Active', 1),
(7, 'abc', '', 'ldn@ldn.vn', '12345678', 'hanoi', 'abc', 0, '', 'Active', 1),
(8, 'vuvy', 'Nam', 'vuvy123@gmail.com', '123232132', 'hanoi', 'vuvy123', 1234, '', 'Active', 1),
(9, 'vuvy123', 'Nam', 'vuvy123@gmail.com', '9348234', 'hanoi', 'vuvy123', 1234, '', 'Active', 1);
...
INSERT INTO `customer_orders` (`order_id`, `customer_id`, `total_price`, `order_date`, `status`, `order_no`, `receiver`, `receiver_sex`, `receiver_phone`, `delivery_location`, `payment_type`, `received_date`, `voucher_code`, `discount_value`, `total_after_discount`) VALUES
(31, 1, 9990000, '2023-08-29', 'Đã giao', 391763615, 'Nguyễn Quang Ninh', 'Anh', '0377238169', 'Hải Phòng', 'Thanh toán tiền mặt khi nhận hàng', '2023-08-29', NULL, 0, 0),
(32, 2, 9990000, '2023-08-29', 'Đang giao', 56293775, 'Phạm Khang Duy', 'Anh', '0123456789', 'Ninh Bình', 'Cà thẻ khi nhận hàng', '0000-00-00', NULL, 0, 0),
(40, 1, 9990000, '2023-08-31', 'Đang giao', 2050707107, 'Nguyễn Quang Ninh', 'Anh', '0377238169', 'Hải Phòng', '', '0000-00-00', NULL, 0, 0),
(43, 1, 4490000, '2023-08-31', 'Đã giao', 1811275033, 'Nguyễn Quang Ninh', 'Anh', '0377238169', 'Hải Phòng', 'Đã thanh toán qua MOMO ATM', '2023-08-31', NULL, 0, 0),
(44, 5, 4490000, '2024-02-27', 'Đã hủy', 291819124, 'Vũ Ngọc Vỹ', 'Anh', '+84363811478', 'ha noi', 'Thanh toán tiền mặt khi nhận hàng', '0000-00-00', NULL, 0, 0),
(45, 6, 4490000, '2024-02-28', 'Đang giao', 1425441566, 'abc', 'Anh', '12345678', 'hanoi', '', '0000-00-00', NULL, 0, 0),
(46, 6, 11490000, '2024-02-28', 'Đang chờ', 1407814012, 'abc', 'Anh', '12345678', 'hanoi', '', '0000-00-00', NULL, 0, 0),
(47, 5, 16480000, '2024-03-07', 'Đang chờ', 814977624, 'Vũ Ngọc Vỹ', 'Anh', '+84363811478', 'ha noi', '', '0000-00-00', NULL, 0, 0),
(48, 5, 5990000, '2024-03-07', 'Đã hủy', 1910602922, 'Vũ Ngọc Vỹ', 'Anh', '+84363811478', 'ha noi', '', '0000-00-00', NULL, 0, 0),
(49, 5, 9990000, '2024-03-07', 'Đã giao', 331347326, 'Vũ Ngọc Vỹ', 'Anh', '+84363811478', 'ha noi', 'Thanh toán tiền mặt khi nhận hàng', '2024-03-07', NULL, 0, 0),
(50, 5, 5990000, '2024-03-07', 'Đã giao', 100672171, 'Vũ Ngọc Vỹ', 'Anh', '+84363811478', 'ha noi', 'Thanh toán tiền mặt khi nhận hàng', '2024-03-07', NULL, 0, 0),
(51, 5, 35970000, '2024-09-08', 'Đang chờ', 2077666649, 'Vũ Ngọc Vỹ', 'Anh', '+84363811478', 'ha noi', 'Thanh toán tiền mặt khi nhận hàng', '0000-00-00', NULL, 0, 0),
(52, 5, 5990000, '2024-09-08', 'Đã hủy', 658122957, 'Vũ Ngọc Vỹ', 'Anh', '+84363811478', 'ha noi', '', '0000-00-00', NULL, 0, 0),
(53, 8, 11990000, '2024-09-22', 'Đang chờ', 1188364144, 'vuvy', 'Anh', '123232132', 'hanoi', 'Thanh toán tiền mặt khi nhận hàng', '0000-00-00', NULL, 0, 0),
(54, 5, 11980000, '2025-11-21', 'Đang chờ', 871084590, 'Vũ Ngọc Vỹ', 'Anh', '+84363811478', 'ha noi', '', '0000-00-00', NULL, 0, 0),
(55, 5, 5990000, '2025-11-21', 'Đang chờ', 962966059, 'Vũ Ngọc Vỹ', 'Anh', '+84363811478', 'ha noi', 'Đã thanh toán qua MOMO ATM', '0000-00-00', NULL, 0, 0),
(56, 5, 5990000, '2025-11-21', 'Đang chờ', 1414349717, 'Vũ Ngọc Vỹ', 'Anh', '+84363811478', 'ha noi', '', '0000-00-00', NULL, 0, 0),
(57, 5, 5990000, '2025-11-21', 'Đang chờ', 1817358587, 'Vũ Ngọc Vỹ', 'Anh', '+84363811478', 'ha noi', '', '0000-00-00', NULL, 0, 0),
(58, 5, 5990000, '2025-11-21', 'Đang chờ', 1695958605, 'Vũ Ngọc Vỹ', 'Anh', '+84363811478', 'ha noi', '', '0000-00-00', NULL, 0, 0),
(59, 5, 5990000, '2025-11-21', 'Đang chờ', 475430515, 'Vũ Ngọc Vỹ', 'Anh', '+84363811478', 'ha noi', '', '0000-00-00', NULL, 0, 0),
(60, 5, 5690000, '2025-11-21', 'Đang chờ', 2069478250, 'Vũ Ngọc Vỹ', 'Anh', '+84363811478', 'ha noi', '', '0000-00-00', NULL, 0, 0);
...
(12, 'MOMOBKUN20180529', 1763712765, '5990000', 'Thanh toán qua MoMo ATM', 'momo_wallet', 2147483647, '', '4733');
...
INSERT INTO `vouchers` (`voucher_id`, `code`, `discount_percent`, `discount_amount`, `quantity`, `min_order`, `max_discount`, `start_date`, `end_date`, `status`) VALUES
(1, 'giam10', 10, 100000, 0, 1000000, 300000, '2025-11-21', '2025-11-22', 'active');
...
--
ALTER TABLE `customer_orders`
  MODIFY `order_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'mã order', AUTO_INCREMENT=61;
