            ...
            <div class="col-lg-12">
                ...
                <?php
                    if(isset($_SESSION['customer_id'])){
                        ...
                        // include statuses that start with 'Đang chờ' (e.g. 'Đang chờ đóng gói')
                        $select_pending_orders = "select * from customer_orders where customer_id = '$customer_id' and (status LIKE 'Đang chờ%' or status LIKE 'Không được xác nhận%')";
