            ...
            <style>
                /* Remove rounded corners only on this product add page */
                #admin-product-add-page .form-control,
                #admin-product-add-page .form-select,
                #admin-product-add-page .btn {
                    border-radius: 0 !important;
                }
            </style>

            <div id="admin-product-add-page" class="row">
                <div class="col-md-12">
