...
<body>
    ...
    ?>
    <?php
    // Ensure required parameters are present; otherwise redirect home
    ...
    <section class="container mt-3" style="min-height: 280px">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7 col-12">
                        <div class="card ">
                            ...
                            <div class="card-body">
                                <p class="card-text">Cảm ơn <strong><?php if($customer_sex == 'Nam'){echo "Anh ".$customer_name;} else{echo "Chị ".$customer_name;} ?> </strong> đã cho PhoneStore cơ hội được phục vụ. 
        ...
        <?php
            // Only include payment handling when the page receives a POST (form submission)
