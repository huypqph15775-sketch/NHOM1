                ...
                <table class="table">
                    ...
                    <?php
                        ...
                        if(isset($_SESSION['customer_id'])){
                            ...
                            // include statuses that start with 'Đang chờ' (for example 'Đang chờ đóng gói' set by MoMo)
                            $select_customer_orders = "select * from customer_orders where customer_id = '$customer_id' and (status LIKE 'Đang chờ%' or status LIKE 'Không được xác nhận%') ORDER BY order_id DESC";
                            ...
                            while($row_customer_orders = mysqli_fetch_array($run_customer_orders)){
                                ...
                                echo "
                                    ...
                                    <td class='";
                                    // treat any status that starts with 'Đang chờ' as pending (warning)
                                    if(strpos($status, 'Đang chờ') === 0) echo "text-warning";
