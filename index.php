...
<body>
    ...
    <section class="cartegory_product">
            ...
            <div class="owl-carousel owl-theme">
              <?php
                ...
                while($row_products = mysqli_fetch_array($run_products)){
                    ...
                    $get_products_img = "select * from product_img where product_id = '$product_id' and product_price > product_price_des AND (product_status IS NULL OR product_status != 'Ngừng bán') LIMIT 0,1";
                    ...
                    while($row_products_img = mysqli_fetch_array($run_products_img)){
                        ...
                        if($product_quantity == 0){
                          echo "<p class='item-price'><strike>$product_price_format</strike> <b>$product_price_des_format</b></p><p class='text-danger fw-bold mt-2'>Hết hàng</p>";
                        } else {
                          echo "<p class='item-price'><strike>$product_price_format</strike> <b>$product_price_des_format</b></p><a href='shop-detail.php?product_id=$product_id&color=$product_color_id' class='btn btn-primary needs-login'>Mua ngay</a>";
                        }
                        echo "
                              </div>
                            </a>
      ...
      <div style="background-color:#F7C14A; border-radius: 15px;" class="container-xl mt-4 banner-sale">
        <span class="title d-block mb-4">CHUỖI MỚI SALE KHỦNG</span>
            <div style="padding-bottom: 25px; margin-top: -22px" class="owl-carousel owl-theme owl-carousel-banner">
              ...
              <div class="item item-banner">
                <a href="">
                  <img src="images/banner6.png" alt="Banner 6">
                </a>
              </div>
            </div>
      </div>
        ...
        <div class="chat-window" id="chatWindow">
            ...
            <div class="chat-messages" id="chatMessages">
                <div class="chat-message">
                    <div class="message-bot">Xin chào! 👋 Chúng tôi có thể giúp bạn điều gì?</div>
                </div>
            </div>
