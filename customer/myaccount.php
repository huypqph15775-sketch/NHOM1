                ...
                <div class="row d-flex align-items-start">
                    <div class="col-lg-3 col-md-4 col-12 pb-4 left-container">
                        ...
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <button onclick="location.href='transaction_history.php'" class="nav-link" id="v-pills-transactions-tab" data-bs-toggle="pill">
                                <i class="fas fa-history pe-3"></i>Lịch sử giao dịch
                            </button>
